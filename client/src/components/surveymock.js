let surveys = [{"id":1,"title":"Questionario Di Prova","owner":1,"public":0,"questions":[{"multiple":false,"id":1,"text":"Alessandro è scemo?","mandatory":0,"order":0},{"multiple":true,"id":2,"text":"Alessandro è nato a...","answers":[{"answer_id":1,"text":"Melfi"},{"answer_id":2,"text":"Torino"},{"answer_id":3,"text":"Milano"},{"answer_id":4,"text":"Bologna"}],"min":1,"max":3,"order":0}]},
 {"id":2,"title":"Proposte per il 15 Agosto","owner":1,"public":0,"questions":[{"multiple":false,"id":1,"text":"Alessandro è scemo?","mandatory":0,"order":0},{"multiple":true,"id":2,"text":"Alessandro è nato a...","answers":[{"answer_id":1,"text":"Melfi"},{"answer_id":2,"text":"Torino"},{"answer_id":3,"text":"Milano"},{"answer_id":4,"text":"Bologna"}],"min":1,"max":3,"order":0}]},
  ...
  const fillableSurvey = (s) => {
    ...
    s.questions.map((q) => {
        if(q.multiple){
            ...
            questions.push({qid: q.id, multiple: true, text: q.text, min: q.min, max:q.max, answers: answers})
        }
        else    
            questions.push({qid: q.id, text: q.text, madatory: q.mandatory, answer:""});
    })
